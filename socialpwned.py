...
if __name__ == "__main__":
    ...
    twitter.add_argument("--limit", default='10', type=int, help="Number of Tweets to pull (Increments of 20).",metavar="limit")
    twitter.add_argument("--year", default=None, type=int, help="Filter Tweets before specified year.",metavar="year")
    twitter.add_argument("--since", default=None, type=str, help="Filter Tweets sent since date (Example: 2017-12-27 20:30:15 or 2017-12-27).",metavar="date")       
    twitter.add_argument("--until", default=None, type=str, help="Filter Tweets sent until date (Example: 2017-12-27 20:30:15 or 2017-12-27).",metavar="date")   
